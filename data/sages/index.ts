...
const SAGES_RAW: Sage[] = [
  ...
  },
  {
    id: "guan-wo-cai",
    name: "管我财",
    title: "港股价值逆向定量派 · 荒岛组合作者",
    era: "2014-至今",
    tier: "popular",
    school: "value",
    philosophy:
      "低估逆向平均赢，排雷排千平常心。5% 股息打底 + 5% 增长 = 10% 年化已经够了。估值是地心引力，雷点能炸掉 5 只好股的收益。",
    coreLine: "贵就是贵不动，雷点不碰，分散睡得着才是真本事。",
    bookOrSource: "雪球《管我财》专栏 / 每年《荒岛投资组合》系列",
    representativeTrades: [
      "招商银行 / 工商银行长期持有（高股息低 PB）",
      "江南布衣港股高股息底仓",
      "2024 年清仓北京首都机场（现场观察免税店挤压餐饮）",
      "持续配置港股 H 股折价资产",
    ],
    dimensions: [
      { key: "valuationLevel", label: "估值水位", weight: 0.30, description: "PE/PB 历史分位现在在哪？贵了立刻没兴趣。" },
      { key: "landmine", label: "排雷扫描", weight: 0.25, description: "负债率、现金流、商誉、大股东动作，一处不放心就出局。" },
      { key: "dividendSafety", label: "股息安全垫", weight: 0.20, description: "派息率多少？股息率有没有 5%？没派息没安全感。" },
      { key: "businessSteady", label: "生意稳态", weight: 0.15, description: "现金流可预测吗？ROE 长期稳吗？不追求暴利。" },
      { key: "islandTest", label: "荒岛测试", weight: 0.10, description: "假如一年不能换，你睡得着吗？睡不着就是仓位太重。" },
    ],
    redFlags: [
      { key: "overvalued", label: "估值过高", trigger: "PE/PB 处于历史分位 80% 以上", severity: "veto" },
      { key: "cashflow_dirty", label: "现金流不干净", trigger: "经营性现金流持续低于净利润", severity: "veto" },
      { key: "controller_dump", label: "大股东减持/质押", trigger: "实控人持续套现 或 高质押率", severity: "major" },
      { key: "goodwill_bomb", label: "高商誉雷", trigger: "商誉 / 净资产 > 30%", severity: "major" },
      { key: "story_stock", label: "讲故事股", trigger: "无盈利支撑的概念股 / 题材炒作", severity: "major" },
    ],
    bonus: [
      "港股 H 股 vs A 股折价 > 30%",
      "派息率 > 50% 且持续 5 年以上",
    ...
    quotes: [
      ...
      "5% 股息打底，剩下交给时间。",
      "估值是地心引力，故事再美也拉不动它。",
      "荒岛上你愿不愿意拿它一年？不愿意，仓位就是太重。",
      "我从来不预测拐点，我等价格自己跌到我心里那个数。",
      "做对的事——就是不碰一切看不懂的、贵的、有疑点的。",
      "分散不是怕错，是承认自己什么都看不准。",
    ],
    misuseWarnings: [
      "成长股 / 高 PE 赛道：管哥的方法论假设有股息+低估，对 PE > 30 的成长股几乎一律 AVOID — 那是张坤/段永平的领域。",
      "短线交易：管哥看分位不看 K 线，如果你想要 3 个月内的判断，他会拒绝回答。",
      "美股科技：管哥主战场是港股 + A 股低估蓝筹，对美股龙头评分不准。",
    ],
    complementarySages: ["duan-yongping", "qiu-guolu"],
    avatar: "GWC",
    color: "#0F766E",
    accentColor: "#FBBF24",
  },
